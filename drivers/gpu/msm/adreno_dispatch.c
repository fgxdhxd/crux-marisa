...
{
	struct adreno_dispatcher *dispatcher = from_timer(dispatcher, t, fault_timer);
	struct adreno_device *adreno_dev = container_of(dispatcher, struct adreno_device, dispatcher);
