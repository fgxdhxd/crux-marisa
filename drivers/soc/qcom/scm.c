...
{
	register u64 r0 asm(R0_REG) = x0;
	register u64 r1 asm(R1_REG) = x1;
	register u64 r2 asm(R2_REG) = x2;
	register u64 r3 asm(R3_REG) = x3;
	register u64 r4 asm(R4_REG) = x4;
	register u64 r5 asm(R5_REG) = x5;
	register u64 r6 asm(R6_REG) = 0;
...
static int __scm_call_armv8_32(u32 w0, u32 w1, u32 w2, u32 w3, u32 w4, u32 w5,
				u64 *ret1, u64 *ret2, u64 *ret3)
{
	register u64 r0 asm(R0_REG) = w0;
	register u64 r1 asm(R1_REG) = w1;
	register u64 r2 asm(R2_REG) = w2;
	register u64 r3 asm(R3_REG) = w3;
	register u64 r4 asm(R4_REG) = w4;
	register u64 r5 asm(R5_REG) = w5;
	register u64 r6 asm(R6_REG) = 0;
	do {
		asm volatile(
#ifdef REQUIRES_SEC
