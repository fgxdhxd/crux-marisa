...
/*
 * Always provide these flags as global symbols so other core files
 * (drivers/input, fs/read_write, etc.) can reference them regardless
 * of whether KPROBES hooking is enabled.
 */
