...
/*
 * Public wrapper expected by fs/devpts/inode.c and other core files.
 * Some internal code uses __ksu_handle_devpts, while the VFS expects
 * ksu_handle_devpts. Provide a thin wrapper to keep both alive.
 */
