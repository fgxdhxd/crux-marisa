					      ...
					      unsigned int nr_pages)
{
	...
	trace_erofs_readpages(mapping->host, list_entry(pages->prev, struct page, lru),
			      nr_pages, false);

	f.headoffset = (erofs_off_t)list_entry(pages->prev, struct page, lru)->index << PAGE_SHIFT;
